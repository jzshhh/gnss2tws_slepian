...
%   timespan         Study period, Start and end dates, e.g., timespan=[20060101 20221231]
% Output:
...
for i=1:n           
    ...
    data(:,i)=movmean(filloutliers(data(:,i),'nearest','mean'),10,'omitnan'); % Applying a 10-day moving average filtering
